...
const description = "Find answers to common questions about our services, pricing, and process — business consulting, tax services, insurance, and AI technology explained.";
const canonical = "/faq";
