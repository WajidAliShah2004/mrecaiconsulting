...
import { FaBullseye, FaHandshake, FaLightbulb, FaUsers, FaAward, FaRocket, FaChartLine, FaShieldAlt, FaCog, FaCheckCircle, FaClock, FaGlobe, FaPhone, FaUserTie, FaArrowRight, FaCalendarAlt, FaCalculator, FaHeart } from 'react-icons/fa';
          ...
          <div className="container-custom">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
              ...
              <motion.div
                ...
                className="group relative bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100"
              >
                <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-red-500 to-pink-500 rounded-t-2xl"></div>
                <motion.div
                  className="w-16 h-16 bg-red-50 rounded-xl flex items-center justify-center mb-6 mx-auto"
                  whileHover={{ rotate: 360, scale: 1.1 }}
                  transition={{ duration: 0.6 }}
                >
                ...
                <p className="text-gray-600 text-center leading-relaxed">
                  Our clients' success is our success. We put their needs first, always.
                </p>
                <div className="absolute -bottom-2 -right-2 w-20 h-20 bg-gradient-to-r from-red-500 to-pink-500 opacity-0 group-hover:opacity-10 rounded-full blur-xl transition-opacity duration-300"></div>
              </motion.div>
            </div>
          </div>
        </section>
              ...
              {[
                {
                  ...
                  description: 'Technology partner building the secure platforms, tools, and infrastructure behind MRECAI\'s client service.',
